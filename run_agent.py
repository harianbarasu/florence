...
class AIAgent:
    ...
    def __init__(
        ...
        Args:
            ...
            credential_pool: Optional shared credential pool for retrying provider-auth failures across accounts.
            persist_session (bool): If False, skip writing conversation state to the session database.
        """
        _install_safe_stdio()
        ...
        self._honcho_manager = honcho_manager
        self._honcho_config_override = honcho_config
                ...
                if _mem_provider_name:
                    ...
                    if self._memory_manager.providers:
                        ...
                        if honcho_session_key:
                            _init_kwargs["honcho_session_key"] = honcho_session_key
                        if honcho_manager is not None:
                            _init_kwargs["honcho_manager"] = honcho_manager
                        if honcho_config is not None:
                            _init_kwargs["honcho_config"] = honcho_config
