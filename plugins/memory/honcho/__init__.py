...
class HonchoMemoryProvider(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        try:
            ...
            cfg = kwargs.get("honcho_config") or HonchoClientConfig.from_global_config()
    ...
    def _do_session_init(self, cfg, session_id: str, **kwargs) -> None:
        ...
        external_manager = kwargs.get("honcho_manager")
        if external_manager is not None:
            self._manager = external_manager
        else:
        ...
        session_key_override = (kwargs.get("honcho_session_key") or "").strip()
        self._session_key = session_key_override or (
