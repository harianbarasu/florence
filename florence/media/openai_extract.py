...
DEFAULT_IMAGE_EXTRACTION_PROMPT = (
    ...
    "For calendar grids, tables, and schedules, act as OCR rather than a calendar interpreter: transcribe visible date numbers, weekday labels, row labels, and event text as shown. "
    "Do not shift, normalize, or convert dates from grid position or weekday math. "
    "Do not invent derived sections such as 'month-by-month logistics', 'important milestones', or date-conversion summaries unless those headings are visibly present. "
    "If a date/event relationship is unclear, write 'date unclear' or 'unclear' rather than guessing. "
