...
def _print_setup_summary(config: dict, hermes_home):
    ...
    if (
        ...
        or _anthropic_web_available
    ):
        tool_status.append(("Web Search & Extract", True, None))
    else:
        tool_status.append(("Web Search & Extract", False, "EXA_API_KEY, PARALLEL_API_KEY, FIRECRAWL_API_KEY, TAVILY_API_KEY, OPENAI_API_KEY, or Anthropic credentials"))
