    ...
    def _build_system_message(
        ...
        *,
        ...
        lines = [
            ...
            "You also have Florence household-state tools. Use them to persist durable work items, routines, meal plans, grocery lists, and future nudges when the user wants Florence to track or manage something over time.",
