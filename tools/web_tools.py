...
def _get_backend() -> str:
    ...
    if configured in ("parallel", "firecrawl", "tavily", "exa", "openai", "anthropic", "searxng", "brave-free", "ddgs"):
        return configured
...
def _is_backend_available(backend: str) -> bool:
    ...
    if backend == "anthropic":
        return _has_anthropic_web_credentials()
    if backend == "searxng":
...
def check_web_api_key() -> bool:
    ...
    if configured in ("exa", "parallel", "firecrawl", "tavily", "openai", "anthropic", "searxng", "brave-free", "ddgs"):
        return _is_backend_available(configured)
    return any(
        _is_backend_available(backend)
        for backend in ("exa", "parallel", "firecrawl", "tavily", "openai", "anthropic", "searxng", "brave-free", "ddgs")
    )
...
if __name__ == "__main__":
    ...
    if web_available:
        ...
        print(
            ...
            "OPENAI_API_KEY, or Anthropic credentials"
