...
class TestVisionRequirements:
    ...
    def test_check_requirements_uses_resolved_vision_client(self):
        with patch("agent.auxiliary_client.resolve_vision_provider_client", return_value=("openai", object(), "gpt-4.1")):
            assert check_vision_requirements() is True

    def test_check_requirements_returns_false_when_no_vision_client_available(self):
        with patch("agent.auxiliary_client.resolve_vision_provider_client", return_value=(None, None, None)):
