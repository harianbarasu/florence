...
// Validate ../../src/app/api/florence/[...path]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/florence/[...path]">> = Specific
  const handler = {} as typeof import("../../src/app/api/florence/[...path]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
